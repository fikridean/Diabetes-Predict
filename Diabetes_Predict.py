...
Original file is located at
    https://colab.research.google.com/drive/1G4xfPBXU56ddFshwYrPS5WUxAoaHOvtc
...
# Penjelasan *Modelling*

Setelah proses *Data Preparation* selesai, langkah berikutnya adalah proses **Modelling**, di mana model akan dibuat dan dilatih menggunakan data *training* serta dievaluasi menggunakan data *testing*. Pada proses ini, tiga algoritma akan digunakan untuk melatih model, yaitu **SVC**, **Random Forest**, dan **K-Nearest Neighbors (KNN)**. Berikut adalah penjelasan, kelebihan, dan kekurangan dari masing-masing algoritma:
...
- **Random Forest**
  ...
  - **Kelebihan**:  
    ...
    - Mampu menangani data hilang dan *outliers*.  
    - Mudah untuk menganalisis fitur penting.  
  - **Kekurangan**:  
...
- **K-Nearest Neighbors (KNN)**
  ...
  - **Kelebihan**:  
    ...
    - Fleksibel dengan berbagai tipe data.  
  - **Kekurangan**:  
    - Waktu inferensi lama.  
    - Sensitif terhadap skala data.  
    - Rentan terhadap *noise* dan data tidak seimbang.  

Dari ketiga algoritma tersebut, model terbaik akan dipilih berdasarkan rata-rata metrik evaluasi setelah proses pembuatan, pelatihan, dan evaluasi selesai dilakukan.
...
"""Dari hasil pelatihan masing-masing model dengan ketiga algoritma yang telah disebutkan sebelumnya, dapat dilihat bahwa algoritma *Random Forest* memiliki rata-rata metrik paling tinggi dari kedua algoritma lainnya. Berdasarkan kelebihan-kelebihan dari algoritma tersebut dan hasil akurasi yang memadai serta merupakan nilai tertinggi dibanding algoritma lainnya, algoritma *Random Forest* menjadi algoritma yang cocok untuk dijadikan sebagai solusi.
